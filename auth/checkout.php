...
$getLocation = ($_GET['id']);
$getData = mysqli_query($connect,("SELECT * from products WHERE id = '$getLocation' "));
    ...
    <div class="page-heading px-4">
            ...
            <section class="section">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="../php/checkout-product.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="basicInput">Destinasi Wisata</label>
                                        <input type="text" class="form-control" value="<?=$File_order['title']; ?>" readonly="true" name="product"></input>
                                    </div>

                                    <div class="form-group">
                                        <label for="basicInput">Lokasi Wisata</label>
                                        <input type="text" class="form-control" value="<?=$File_order['location']; ?>" readonly="true" name="location"></input>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="basicInput">Harga</label>
                                        <input class="form-control" name="price" value="<?=$File_order['price']; ?>" readonly="true"></input>
                                    </div>
                                    <div class="form-group">
