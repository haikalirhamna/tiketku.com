...
<head>
    ...
    <title>Register - Tiketku.com</title>
    ...
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <form  action="../php/register.php" method="POST">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="password" class="form-control form-control-xl" placeholder="Confirm Password" name="confirm" required>
                    <div class="form-control-icon">
                        <i class="bi bi-shield-lock"></i>
                    </div>
                </div>
                <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="submit" name="signup">Sign Up</button>
            </form>
