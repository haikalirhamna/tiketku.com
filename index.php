    ...
    <body>
        ...
        <nav class="navbar header">
            <div class="container">
                ...
                <div class="navbar-link">
                    ...
                    <a href="#" class="me-3">Cek order</a>
                    <a class="btn btn-primary" href="guest/auth-register.php">Daftar</a>
                    <a class="btn btn-primary" href="guest/auth-login.php">Masuk</a>
                </div>
            </div>
        </nav>
        <!-- Masthead-->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            <div class="features-icons-icon d-flex"><i class="bi bi-currency-dollar m-auto text-primary"></i></div>
                    ...
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            <div class="features-icons-icon d-flex"><i class="bi bi-clipboard-data m-auto text-primary"></i></div>
                            <h3>Tujuan Populer</h3>
                            <p class="lead mb-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi, cumque?</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                            ...
                            <h3>Easy to Use</h3>
                            <p class="lead mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis, nemo!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="showcase">
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('assets/img/bali.jpeg')"></div>
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                        <h2>Staycation di Bali</h2>
                        <p class="lead mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores incidunt illo architecto? Tempore necessitatibus at atque, non recusandae quis quisquam.</p>
                    </div>
                </div>
                <div class="row g-0">
                    <div class="col-lg-6 text-white showcase-img" style="background-image: url('assets/img/bandung.jpg')"></div>
                    <div class="col-lg-6 my-auto showcase-text">
                        <h2>Liburan ke Bandung</h2>
                        <p class="lead mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad quo omnis non quae maiores ullam error vero itaque atque possimus!</p>
                    </div>
                </div>
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('assets/img/jakarta.jpg')"></div>
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                        <h2>Event di Jakarta</h2>
                        <p class="lead mb-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor voluptas deserunt optio tempora delectus assumenda quidem accusamus, possimus deleniti. Non.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            ...
                            <h5>Sarah W.</h5>
                            <p class="font-weight-light mb-0">"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero maiores a autem!"</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-auto" id="btn-filter">
                            ...
                            if ($check > 0) {
                                while ($row = mysqli_fetch_array($getData)) {
                                    echo "<a href='auth/product-list.php?location=$row[location]'><button class='btn btn-transparent me-1'>$row[location]</button></a>";
                                }
                            }
                        ...
                        <?php
                            ...
                            if ($check > 0) {
                                while ($row = mysqli_fetch_assoc($getData)) {
                                    ...
                                    <a href='auth/checkout.php?id=$row[id]' class='link-primary' class='card-subtitle'>
